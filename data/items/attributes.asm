...
; WATER_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; OCCA_BERRY
	item_attribute 10, HELD_FIRE_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HP_UP
...
; PASSHO_BERRY
	item_attribute 10, HELD_WATER_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FRESH_WATER
...
; WACAN_BERRY
	item_attribute 10, HELD_ELECTRIC_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_DEFEND
...
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RINDO_BERRY
	item_attribute 10, HELD_GRASS_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AMULET_COIN
...
; BLK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; YACHE_BERRY
	item_attribute 10, HELD_ICE_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PNK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
...
; CHOPLE_BERRY
	item_attribute 10, HELD_FIGHTING_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
...
; PASS
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KEBIA_BERRY
	item_attribute 10, HELD_POISON_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHUCA_BERRY
	item_attribute 10, HELD_GROUND_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; COBA_BERRY
	item_attribute 10, HELD_FLYING_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; PAYAPA_BERRY
	item_attribute 10, HELD_PSYCHIC_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TANGA_BERRY
	item_attribute 10, HELD_BUG_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
...
; CHARTI_BERRY
	item_attribute 10, HELD_ROCK_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
	item_attribute 200, HELD_LEFTOVERS, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KASIB_BERRY
	item_attribute 10, HELD_GHOST_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HABAN_BERRY
	item_attribute 10, HELD_DRAGON_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; COLBUR_BERRY
	item_attribute 10, HELD_DARK_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEPPA_BERRY
...
; BERSERK_GENE
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BABIRI_BERRY
	item_attribute 10, HELD_STEEL_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ROSELI_BERRY
	item_attribute 10, HELD_FAIRY_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHILAN_BERRY
	item_attribute 10, HELD_NORMAL_RESIST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SACRED_ASH
