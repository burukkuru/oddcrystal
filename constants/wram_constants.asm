...
; wTrainerDifficulty::
DEF TRAINERDIFFICULTY_EASY      EQU 09
DEF TRAINERDIFFICULTY_NORMAL    EQU 10
DEF TRAINERDIFFICULTY_HARD      EQU 11
DEF TRAINERDIFFICULTY_HARDPLUS  EQU 12
DEF TRAINERDIFFICULTY_ODD       EQU 13
