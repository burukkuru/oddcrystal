...
; wTrainerDifficulty::
DEF TRAINERDIFFICULTY_EASY      EQU $00
DEF TRAINERDIFFICULTY_NORMAL    EQU $20
DEF TRAINERDIFFICULTY_HARD      EQU $40
DEF TRAINERDIFFICULTY_HARDPLUS  EQU $60
DEF TRAINERDIFFICULTY_ODD       EQU $7f
